...
create table room(
	...
	status TINYINT DEFAULT 0 comment '0可预订，1已经预定',
	start_time DATETIME comment '房间开始时间',
	end_time DATETIME comment '房间结束时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
create table transaction(
	...
	status TINYINT DEFAULT 0 comment '订单状态0-无效1-有效',
